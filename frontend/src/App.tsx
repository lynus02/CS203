...
export default function App() {
    ...
    const { savedProducts, fetchSavedProducts, removeSavedProduct, isLoading } =
        useSavedProducts();
    ...
    const features = [
        {
            ...
            description:
                "Calculate import duties and taxes for food products based on value and tariff rates"
        },
        {
            icon: Ship,
            title: "Shipping Cost Calculator",
            description:
                "Estimate shipping costs for air, sea, and ground transportation"
        },
        {
            icon: DollarSign,
            title: "Total Landed Cost",
            description:
                "Calculate the complete cost including all fees, taxes, and duties"
        },
        {
            icon: Database,
            title: "Food Tariff Database",
            description:
                "Search current food tariff rates by HS code and country"
        }
    ];
                ...
                <div className="border-b border-border ">
                    ...
                    FoodTariff Pro
                        ...
                        <span
                            ...
                            className="text-primary hover:underline font-medium cursor-pointer text-lg"
                        >
                          Login
                        </span>{" "}
                    ...
                    <div className="container mx-auto px-4 py-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                Specialized tariff and shipping cost calculator for food imports
                                and exports. Calculate customs duties, shipping costs, and total
                                landed costs for food products with ease.
                            </p>
                        </div>
                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                            <TabsList
                                className="bg-primary grid w-full"
                            ...
                            <CardContent>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm">
                                            Use the correct 6-10 digit Harmonized System code for
                                            accurate tariff rates. Check with customs authorities for
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm">
                                            Food imports require additional documentation like health
                                            certificates, FDA registration, and may face inspection
                                            delays at customs.
                                        </p>
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm">
                                            Check for preferential trade agreements that may reduce or
                                            eliminate tariffs between specific countries.
                                        </p>
                                    </div>
                                </div>
                            </CardContent>
                        ...
                        <div className="mt-12 text-center text-sm text-muted-foreground">
                            <p>
                                Disclaimer: This calculator provides estimates based on general
                                tariff information. Always consult official customs authorities
                                for accurate, up-to-date rates and regulations.
                            </p>
                        </div>
                    </div>
                </div>
